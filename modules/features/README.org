...
* Creating features
  ...
  components/:
  #+BEGIN_EXAMPLE
  drush @lbd_dev help features-components
  drush @lbd_dev features-components '%:%' > features-components.txt
  #+END_EXAMPLE
...
* Saving and restoring private variables
  ...
  works like this:
  #+BEGIN_EXAMPLE
  features/save-private-vars.sh @lbd_dev
  drush @lbd_dev php-script restore-private-vars.php
  #+END_EXAMPLE
