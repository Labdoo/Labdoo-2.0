...
* Pushing commits to github
  ...
  clones of the git repository at https://github.com/Labdoo/Labdoo-2.0
...
* Making a local git clone of the dev application
  ...
  *@dev* application (~/var/www/lbd_dev~). For example this is the
  ...
  [[https://github.com/Labdoo/Labdoo-2.0][GitHub repository]] it is easy to push commits from /lbd_dev/ to
