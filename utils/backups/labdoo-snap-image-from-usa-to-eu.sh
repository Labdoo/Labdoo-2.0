...
profile_src=labdoo                                          # Source profile where instance resides
profile_dst1=migjornUS                                      # Destination profile where backup AMI is to be shared 
profile_dst2=migjornEU                                      # Destination profile where backup AMI is to be replicated 
